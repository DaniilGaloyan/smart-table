...
export const initPagination = ({pages, fromRow, toRow, totalRows}, createPage) => {
    ...
    const applyPagination = (query, state, action) => {  // формирует параметры пагинации до получения данных
    ...
    const updatePagination = (total, { page, limit }) => {  // перерисовывает пагинатор после получения данных
